        ...
        <div className="lg:hidden bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 px-4 py-3 space-y-1.5 animate-fadeIn">
          {navItems.map(item => (
            <button
              ...
              className={`w-full text-left px-4 py-3 rounded-xl text-sm font-bold transition flex items-center min-h-[44px] ${
                activeTab === item.id
          ...
          {user && (
            <button
              ...
              className="w-full text-left px-4 py-3 rounded-xl text-sm font-bold text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800/50 flex items-center gap-2 transition min-h-[44px]"
            >
              <LogOut className="w-4 h-4" />
